...
# PLot 2: Have total emissions from PM2.5 decreased in 
# the Baltimore City, Maryland (𝚏𝚒𝚙𝚜 == "𝟸𝟺𝟻𝟷𝟶") from
...
# sum data by year
TotalEmissionsByYear <- aggregate(baltimore$Emissions, 
    by = list(baltimore$year), FUN = sum)

# create plot and save as png
filePath <- paste0(getwd(), "/coursera/ExpData_CProj2/plot2.png")
png(filePath, width = 480, height = 480, units = "px")
plot(TotalEmissionsByYear[ ,1], TotalEmissionsByYear[ ,2], 
     xlab = "Year", ylab = "Baltimore Total PM2.5 Emmisions", 
     main = "Baltimore Total PM2.5 Emmisions by Year")
